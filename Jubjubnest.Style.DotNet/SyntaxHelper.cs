...
namespace Jubjubnest.Style.DotNet
{
	...
	internal static class SyntaxHelper
	{
		...
		/// <summary>
		/// Resolves if the context is from auto-generated code.
		/// </summary>
		/// <param name="context">The content for the analysis.</param>
		/// <returns>True if the content is auto-generated.</returns>
		public static bool IsAutoGenerated( SyntaxNodeAnalysisContext context )
		{
			// Delegate.
			return IsAutoGenerated( context.SemanticModel.SyntaxTree );
		}

		/// <summary>
		/// Resolves if the content is from auto-generated code.
		/// </summary>
		/// <param name="context">The content for the analysis.</param>
		/// <returns>True if the content is auto-generated.</returns>
		public static bool IsAutoGenerated( SyntaxTreeAnalysisContext context )
		{
			// Delegate.
			return IsAutoGenerated( context.Tree );
		}

		/// <summary>
		/// Resolves if the syntax tree is from auto-generated code.
		/// </summary>
		/// <param name="syntaxTree">The syntax tree for the analysis.</param>
		/// <returns>True if the content is auto-generated.</returns>
		public static bool IsAutoGenerated( SyntaxTree syntaxTree )
		{
			// Detect auto-generated code by the file name.
			if( syntaxTree.FilePath.Contains( ".Designer." ) )
				return true;

			// Assume not auto-generated.
			return false;
		}
	}
}
