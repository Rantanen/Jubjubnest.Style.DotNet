...
namespace TestHelper
{
	...
	public abstract partial class DiagnosticVerifier
	{
		...
		private static Diagnostic[] GetSortedDiagnostics( TestEnvironment env, string[] sources, string language, DiagnosticAnalyzer analyzer )
		{
			return GetSortedDiagnosticsFromDocuments( analyzer, GetDocuments( env, sources, language ) );
		}
		...
		private static Document[] GetDocuments( TestEnvironment env, string[] sources, string language )
		{
			...
			var project = CreateProject( env, sources, language );
		...
		protected static Document CreateDocument( TestEnvironment env, string source, string language = LanguageNames.CSharp )
		{
			return CreateProject( env, new[] { source }, language ).Documents.First();
		}
		...
		private static Project CreateProject( TestEnvironment env, string[] sources, string language = LanguageNames.CSharp )
		{
